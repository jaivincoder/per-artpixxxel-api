...
namespace api.artpixxel.repo.Utils.Generator.Config
{
    /// <summary>
    ...
    public class GenerationOptions
    {
        ...
        public GenerationOptions(bool useNumbers = false, bool useSpecialCharacters = true, int? length = null)
        {
            ...
            Length = length ??
                     RandomUtils.GenerateNumberInRange(GeneratorConstant.MinimumAutoLength, GeneratorConstant.MaximumAutoLength);
        }
    }
}
