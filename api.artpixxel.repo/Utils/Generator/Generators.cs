...
using api.artpixxel.repo.Utils.Generator.Util;
using System;
...
namespace api.artpixxel.repo.Utils.Generator
{
   public static class Generators
    {
        ...
        public static string Generate(GenerationOptions options)
        {
            ...
            if (options.Length < GeneratorConstant.MinimumAutoLength)
                throw new ArgumentException(
                    $"The specified length of {options.Length} is less than the lower limit of {GeneratorConstant.MinimumAutoLength} to avoid conflicts.");
        ...
        public static void SetCharacters(string characters)
        {
            ...
            if (charSet.Length < GeneratorConstant.MinimumCharacterSetLength)
                throw new InvalidOperationException(
                    $"The replacement characters must be at least {GeneratorConstant.MinimumCharacterSetLength} letters in length and without whitespace.");
